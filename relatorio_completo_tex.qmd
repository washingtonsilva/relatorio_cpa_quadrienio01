...
O Relatório Integral da Comissão de Autoavaliação do Programa de 
Pós-Graduação em Administração do IFMG - Campus Formiga, referente ao 
quadriênio 2021-2024, apresenta uma análise abrangente e reflexiva sobre 
o desempenho do programa sob a ótica dos diferentes segmentos acadêmicos. 
Este documento foi elaborado em conformidade com a Política de Autoavaliação, 
formalizada pela Portaria Nº 1706/IFMG/2024 [@portaria1706ifmg], que 
estabelece diretrizes para um processo avaliativo estruturado e permanente.

O Programa de Pós-Graduação em Administração iniciou suas atividades em 2021, 
em um contexto desafiador marcado pela pandemia da COVID-19. Desde o início, 
o programa demonstrou resiliência e dedicação à construção de uma base 
sólida para a formação de pesquisadores qualificados em usa área de atuação. 
Além dos desafios impostos pela pandemia, o cenário da pós-graduação no Brasil 
tem sido impactado por uma redução no interesse dos candidatos potenciais, 
conforme apontam estudos recentes [@marques2024]. Esta queda na demanda por 
cursos de mestrado e doutorado, associada a substanciais restrições de 
financiamento e mudanças rápidas e potencialmente disruptivas no mercado 
de trabalho, impulsionadas pelo avanço tecnológico — como o desenvolvimento 
da Inteligência Artificial e outras inovações digitais — observadas neste 
início do século XXI, impõe desafios adicionais para a sustentabilidade e 
consolidação dos programas de pós-graduação stricto sensu, sejam 
profissionais ou acadêmicos.

Isto posto, a metodologia aplicada na autoavaliação foi planejada para 
fornecer informações amplas e adequadas a um programa tão recente, iniciado 
sob o cenário descrito, além de garantir uma representatividade apropriada 
...
foram analisadas dimensões como qualidade do ensino, infraestrutura e gestão administrativa. A análise crítica dos dados coletados buscou não apenas 
identificar as principais demandas, mas também propor ações concretas e 
bem fundamentadas para o aprimoramento contínuo do programa.

Os resultados obtidos ao longo do quadriênio destacaram resultados 
significativos e positivos sobre qualificação do corpo docente, 
adequação de diversos aspectos da matriz curricular, da infraestrutura, 
entre outros. Contudo, como esperado, também foram identificadas 
oportunidades de melhoria em áreas como revisão do currículo em face dos 
resultados e avaliações realizadas no quadriênio, infraestrutura, atividades 
extracurriculares e internacionalização. 
...
os avanços alcançados e os desafios enfrentados, ele fornece subsídios 
para decisões futuras que visem à sustentabilidade e à evolução do curso 
...
de forma que o processo avaliativo contribua efetivamente para a consolidação e 
...
Metodologia aplicada (@sec-metodologia), Resultados da Autoavaliação (@sec-resultados), 
Ações Executadas e Demandadas a partir da Autoavaliação (@sec-acoesdemanda) e 
...
- **Cronograma detalhado:** Planejamento das ações avaliativas com 
...
Portaria IFMG nº 1706/2024 [@portaria1706ifmg]. Esta seção descreve 
os procedimentos adotados para a coleta e análise dos dados, os instrumentos 
utilizados e as técnicas e procedimentos empregados no processo autoavaliativo.


## Metodologia Aplicada ao Processo de Autoavaliação

A metodologia aplicada na autoavaliação foi desenvolvida com base na 
Política de Autoavaliação formalizada pela Portaria Nº 1706/IFMG/2024. 
O objetivo principal foi promover uma reflexão crítica que orientasse 
ações para a melhoria contínua do programa. 

O processo metodológico seguiu quatro etapas integradas:

1. **Planejamento:** Revisão das diretrizes normativas da CAPES e definição 
dos critérios avaliativos, abrangendo ensino, pesquisa, extensão e gestão 
acadêmica.

2. **Engajamento:** Promoção da participação ativa de discentes e 
docentes por meio de campanhas informativas.

3. **Execução:** Aplicação anual dos instrumentos avaliativos pela Comissão de Autoavaliação, 
composta por representantes dos segmentos acadêmicos do programa.

4. **Meta-avaliação:** Revisão crítica dos métodos aplicados para aprimorar 
continuamente o processo.

Os instrumentos utilizados incluíram questionários com 
questões quantitativas (escalas Likert) e qualitativas (respostas abertas), 
abordando dimensões como qualidade do ensino, infraestrutura, disciplinas 
e coordenação do curso, entre outras. A análise dos dados seguiu 
uma abordagem mista, os dados quantitativos foram analisados com
técnicas estatísticas descritivas, notamente frequências percentuais e 
diversos tipos de gráficos, enquanto os dados qualitativos foram examinados 
usando a método de categorização temática.

A estrutura dos questionários aplicados buscou um alinhamento com o 
estágio de maturidade de curso, o qual é recente, o que demandou 
uma análise abrangente. A alta quantidade de questões, distribuídas 
em diversas dimensões avaliativas, foi intencionalmente projetada 
para captar avaliações e percepções detalhadas, incluindo sugestões 
específicas dos diferentes segmentos acadêmicos. Essa abordagem 
é especialmente relevante para um programa recente, iniciado em 2021, 
que busca promover melhorias contínuas fundamentadas em evidências. 
Isto posto, a amplitude das questões evidencia o esforço efetivo 
do processo avaliativo para contribuir para a evolução do curso.

Os resultados obtidos foram consolidados em relatórios e 
amplamente divulgados aos segmentos acadêmicos, tanto pelo site 
institucional do Mestrado quanto por meio de e-mails informativos. 
Essa estratégia assegurou a transparência e a disseminação do 
processo avaliativo.

Por fim, a meta-avaliação revisou criticamente os instrumentos e 
métodos aplicados ao longo do ciclo avaliativo, garantindo a validade e 
confiabilidade dos resultados obtidos. Essa etapa final reforçou o 
compromisso do programa com a excelência acadêmica e administrativa.
...
na @tbl-5.2 da @sec-acoesdemanda, Ações Executadas e Demandadas a Partir da Autoavaliação. Essa decisão foi tomada para evitar redundâncias 
no relatório e apresentar as análises de maneira objetiva e focada nas 
melhorias concretas propostas. 

No entanto, para proporcionar uma visão geral das informações extraídos dos 
dados coletados, foram incluídas subseções específicas contendo sínteses 
dos principais resultados obtidos junto ao corpo discente 
(@sec-sintesediscentes) e ao corpo docente (@sec-sintesedocentes). 
...
direcionados aos discentes e docentes, abrangendo aspectos como 
qualidade do ensino, infraestrutura, coordenação do programa e 
impacto da pandemia da COVID-19, entre outros. Os dados coletados 
...
Os resultados da autoavaliação do corpo discente indicaram altos 
níveis de satisfação em dimensões como a qualidade do curso, a atuação 
dos docentes, a coordenação do programa e o atendimento da Secretaria, 
e com outras dimensões. No entanto, foram identificadas oportunidades 
de melhoria em aspectos como infraestrutura (especialmente o espaço 
de convivência) e ampliação de atividades extracurriculares. As sugestões 
fornecidas pelos discentes indicam a necessidade de revisão das disciplinas 
obrigatórias e optativas, incluindo sua sequência, para aperfeiçoar seu
alinhmento às linhas de pesquisa do mestrado e às demandas específicas 
dos discentes que desenvolvem projetos nas respectivas linhas.


### Taxas de Resposta {#sec-taxadiscentes}

As taxas de resposta dos discentes por ano ou turma de ingresso 
apresentam variações, conforme a Tab. 4.1. A turma 
de ingressantes de 2023 se destaca positivamente com uma taxa de 
resposta de 100%, evidenciando um engajamento pleno dos estudantes. Por 
outro lado, turmas como a de 2021 (22%) e 2024 (43%) apresentaram níveis 
de participação abaixo do ideal, o que aponta para a necessidade de 
estratégias mais eficazes de sensibilização e engajamento. Importante 
destacar que a turma de ingressantes em 2023 foi fortemente afetada 
pelos impactos negativos da pandemia da COVID-19.
...
### Perfil dos Participantes {#sec-caractdiscentes}
...
coletadas por meio de questões abertas e refletem as percepções dos 
...
avaliativo, com destaque para avaliações positivas sobre a qualidade 
geral do programa, entre outras dimensões bem avaliadas. Por outro lado, 
foram apontadas necessidades de revisão do currículo e limitações 
na infraestrutura, como a necessidade de ambientes mais adequados para 
aulas híbridas. Além disso, os docentes sugeriram ações estratégicas 
para ampliar o incentivo à pesquisa por meio de maior acesso a bases 
de dados especializadas, recursos computacionais, softwares e uma maior 
mobilização para a prospeção de parcerias e para a captação de 
recursos externos.


### Taxa de Resposta  {#sec-docentestaxa}

A Tab. 4.3 mostra que a taxa de resposta do corpo docente atingiu 73%, 
...
possibilitou a identificação de avanços, desafios e oportunidades 
...
Nesta seção, apresentam-se as ações já implementadas em resposta às demandas identificadas ao longo do quadriênio (@sec-executadas), bem como aquelas 
...
tabela_demandas <- data.frame(
  Demanda = c(
    ...
    "Demanda por redução da carga de disciplinas obrigatórias, considerando o perfil profissional dos mestrandos.",
...
tabela_acoes_demandadas <- data.frame(
  Demanda = c(
    ...
    "Solicitar às instâncias competentes do IFMG a ampliação do acesso à bases de dados especializadas, recursos computacionais, softwares e literatura especializada para apoiar as atividades de pesquisa do programa.",
    "Expandir as oportunidades de atividades extracurriculares, de extensão e 
    de internacionalização para enriquecer a experiência acadêmica dos mestrandos.",
    "Ampliar a prospecção e a interação com empresas da região para fortalecer 
    as parcerias atuais e criar novas parcerias e oportunidades de pesquisa.",
    ...
    "Encaminhar às instâncias competentes do IFMG a demanda por um anfiteatro maior para eventos acadêmicos, para aumentar a capacidade de realização de seminários e congressos."
  ),
  Representacao = c(
    "Colegiado do curso",
...
Os resultados da meta-avaliação indicaram avanços significativos no processo 
avaliativo do programa, mas também apontaram aspectos que podem ser 
aprimorados:
...
Criado em um período desafiador, marcado pela pandemia da COVID-19, 
o programa demonstrou resiliência ao consolidar suas bases acadêmicas e 
administrativas, superando adversidades e garantindo a continuidade 
das atividades de ensino, pesquisa e extensão. Por meio de um processo 
avaliativo estruturado e alinhado à Política de Autoavaliação formalizada pela 
Portaria Nº 1706/IFMG/2024, o relatório apresenta um panorama abrangente 
dos avanços alcançados, desafios enfrentados e direções estratégicas 
para o aprimoramento do curso.

Desde sua criação em 2021, o programa tem buscado consolidar suas bases 
acadêmicas e administrativas, destacando-se pelo alto nível de 
qualificação do corpo docente, pela adequação de diversos aspectos 
da matriz curricular, da infraestrutura e da gestão acadêmica, 
conforme pode se verificar nos resultados apresentados. Além disso, 
a estrutura avaliativa utilizada foi considerada abrangente e eficiente na c
aptação de percepções sobre ensino, pesquisa, infraestrutura e gestão 
administrativa.  

Por outro lado, o processo de autoavaliação identificou áreas que apresentam oportunidades de aprimoramento, especialmente no que se refere à necessidade 
de revisão da matriz curricular — um aspecto esperado e desejável para um 
programa recente que passará por sua primeira avaliação quadrienal. Também 
foram apontadas demandas estratégicas para o aperfeiçoamento da 
infraestrutura, a ampliação das atividades extracurriculares, o 
fortalecimento da internacionalização e o aumento da prospecção de 
oportunidades de pesquisa e interação com o setor produtivo. Além disso, identificaram-se oportunidades para aprimorar a comunicação institucional.  

Isto posto, foram identificadas demandas estratégicas para os 
próximos ciclos avaliativos, com foco na reestruturação curricular, no 
aperfeiçoamento da infraestrutura, na promoção de incentivos à pesquisa e 
na expansão das atividades extracurriculares. A implementação dessas ações 
será monitorada pela Comissão de Autoavaliação, para que as 
mudanças propostas contribuam efetivamente para o fortalecimento do 
programa e a evolução da formação oferecida.  

Este relatório reforça a relevância do processo avaliativo como 
instrumento de gestão e aprimoramento contínuo, permitindo que o 
programa se adapte às demandas institucionais e de mercado. A reflexão 
crítica proporcionada pela autoavaliação pode orientar o planejamento estratégico 
do curso e fortalecer sua capacidade de formar profissionais qualificados 
para enfrentar os desafios contemporâneos, contribuindo efetivamente para o 
desenvolvimento local, regional e nacional.  

Além dos avanços e desafios identificados, a Comissão de Autoavaliação 
também realizou uma Meta-Avaliação do processo, revisando criticamente 
os instrumentos e métodos aplicados. Esse aprendizado resultou em 
recomendações para tornar os próximos ciclos avaliativos mais eficazes 
e alinhados às necessidades do programa. 

Considerando o cenário nacional da pós-graduação, marcado por uma 
redução no interesse de potenciais candidatos [@marques2024] e por desafios 
institucionais, a autoavaliação contínua será um fator crítico para 
garantir a atratividade e a sustentabilidade do curso. A implementação 
de estratégias voltadas à atração e retenção de discentes com perfil 
apropriado, entre outras ações, aliadas à formulação e execução de um 
planejamento estratégico flexível, porém assertivo, contribuirá para a 
sustentabilidade e a consolidação do programa como uma referência na área.
