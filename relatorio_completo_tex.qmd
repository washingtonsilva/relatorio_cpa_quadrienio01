...
O Relatório Integral da Comissão Própria de Avaliação (CPA) do Programa de 
...
(@sec-planejamento), metodologia aplicada (@sec-metodologia), 
...
da CPA e da comunidade acadêmica para promover um ambiente de reflexão 
crítica e engajamento.

Ao longo do quadriênio, foram aplicados instrumentos avaliativos 
diversificados que captaram percepções de discentes, docentes e 
técnicos administrativos. Os dados coletados foram analisados com rigor 
metodológico e apresentados em workshops voltados à discussão dos resultados. 
Esse processo assegurou transparência, inclusão e a construção de uma cultura 
voltada ao aperfeiçoamento contínuo.

Por fim, este relatório não apenas documenta os avanços alcançados pelo 
...
monitorada pela CPA em ciclos avaliativos subsequentes, reafirmando 
o compromisso do programa com a formação de profissionais qualificados 
para atender às demandas sociais e do mercado.
...
Comissão Própria de Avaliação (CPA) durante o quadriênio, incluindo 
...
3. **Execução:** Aplicação anual dos instrumentos avaliativos pela CPA, 
...
e coordenação do curso. A análise dos dados seguiu uma abordagem mista:

- Dados quantitativos foram analisados por técnicas estatísticas 
descritivas (médias, percentuais e gráficos).

- Dados qualitativos foram examinados por análise de conteúdo com 
categorização temática.

Os resultados obtidos foram consolidados em relatórios apresentados à 
comunidade acadêmica em workshops dedicados à reflexão coletiva. Essa 
abordagem assegurou transparência e inclusão no processo avaliativo, 
permitindo identificar pontos fortes, desafios e oportunidades de melhoria.
...
Este capítulo apresenta os resultados da pesquisa de autoavaliação 
conduzida no Mestrado Profissional em Administração do IFMG - Campus Formiga, 
...
impacto da pandemia da COVID-19. Os dados coletados foram analisados 
de maneira quantitativa e qualitativa, permitindo identificar 
pontos fortes, desafios e oportunidades de melhoria. Este capítulo 
detalha os principais achados e reflexões resultantes desse processo.
...
- Infraestrutura disponível (@sec-avainfradiscentes) e atendimeento 
...
### Características dos Discentes {#sec-caractdiscentes}
...
```{r}
#| label: fig-4.2
#| fig-cap: "Atividades remuneradas exercidas pelos discentes participantes da pesquisa."
...
2021-2024, a Comissão Própria de Avaliação (CPA) propôs um conjunto de 
...
Além disso, a CPA considerou informações complementares obtidas ao longo 
do quadriênio, como discussões realizadas, reuniões e 
feedbacks informais da comunidade acadêmica. Esse esforço resultou em 
uma síntese que equilibra as demandas da comunidade acadêmica com a visão 
...
A CPA buscou garantir que essas ações fossem representativas das necessidades 
identificadas pelos diferentes segmentos acadêmicos — discentes, docentes, 
técnicos administrativos e representantes externos. A implementação dessas 
ações será monitorada em ciclos avaliativos futuros, assegurando que os 
resultados contribuam efetivamente para o aprimoramento contínuo do programa.
...
aos segmentos acadêmicos (discentes, docentes, técnicos administrativos e 
egressos), com foco na clareza das perguntas e na abrangência das dimensões 
avaliadas.
...
3. **Consulta à Comunidade Acadêmica**: Realização de workshops e reuniões 
para discutir os resultados da autoavaliação e coletar feedbacks sobre o 
processo avaliativo.
...
A meta-avaliação representou uma etapa de grande aprendizagem para a CPA 
neste primeiro ciclo avaliativo do Programa de Pós-Graduação em Administração 
do IFMG - Campus Formiga. Ao refletir criticamente sobre os métodos 
utilizados, a CPA empenhou-se em promover melhorias contínuas no processo 
avaliativo, com o objetivo de que ele contribua de forma efetiva para 
...
O Relatório Integral da Comissão Própria de Avaliação (CPA) do Programa 
de Pós-Graduação em Administração do IFMG - Campus Formiga, referente ao 
quadriênio 2021-2024, evidencia o compromisso institucional com a 
melhoria contínua do programa, baseada em evidências. Iniciado em 2021, 
em um período crítico marcado pela pandemia da COVID-19, o programa 
enfrentou desafios significativos logo em seus primeiros anos. Ainda 
assim, o processo de autoavaliação demonstrou a resiliência e o 
comprometimento do curso com sua evolução e consolidação.

A autoavaliação foi conduzida de forma estruturada, alinhada à Política de 
Autoavaliação formalizada pela Portaria Nº 1706/IFMG/2024 [@portaria1706ifmg]. 
Este processo permitiu uma análise abrangente das dimensões avaliadas — 
ensino, pesquisa, extensão, infraestrutura e gestão — destacando tanto os 
pontos fortes quanto as áreas que demandam aprimoramento. 

**Entre as dimensõs bem avaliadas identificadas estão a qualidade geral 
do programa e do corpo docente, diversos aspectos das disciplinas e  
infraestrutura disponível, entre outras. Por outro lado, foram apontadas oportunidades de melhoria relacionadas à infraestrutura e à ampliação de atividades extracurriculares, entre outras.**

A meta-avaliação, realizada como etapa final do ciclo avaliativo, 
desempenhou um papel essencial ao revisar criticamente os instrumentos e 
métodos aplicados. Essa etapa validou a eficácia do processo avaliativo e 
gerou recomendações importantes para ajustes futuros. Entre as principais 
recomendações estão a revisão dos instrumentos avaliativos para maior 
clareza e especificidade, o desenvolvimento de indicadores mais detalhados 
e a ampliação das estratégias de engajamento dos segmentos acadêmicos.

As ações demandadas a partir da autoavaliação foram organizadas em dimensões 
estratégicas e detalhadas na Tab. 5.1 deste relatório. Essas ações visam 
consolidar os avanços alcançados e superar os desafios identificados, 
promovendo melhorias na matriz curricular, na infraestrutura e no planejamento 
estratégico do programa. Além disso, reforçam o compromisso com a construção 
de um ambiente acadêmico inclusivo, inovador e alinhado às demandas 
institucionais e sociais.

Por fim, este relatório destaca que o Programa de Pós-Graduação em 
Administração do IFMG - Campus Formiga está comprometido com sua evolução 
contínua. A implementação das ações propostas será monitorada pela CPA 
em ciclos avaliativos futuros, assegurando que os resultados contribuam 
efetivamente para o aperfeiçoamento do programa. A reflexão crítica 
proporcionada pela autoavaliação fortalece não apenas a qualidade 
acadêmica e administrativa do curso, mas também sua capacidade de 
formar profissionais preparados para enfrentar os desafios contemporâneos 
