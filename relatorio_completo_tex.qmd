...
```{r}
#| label: tab-01
#| tbl-cap: "Taxas de Respostas da Autoavaliação por Ano/Turma de Ingresso e Total."
...
```{r}
#| label: fig-4.81
#| fig-cap: "Avaliação docente do processo de distribuição de bolsas."
#| fig-width: 4
#| fig-height: 4
...
```{r}
#| label: fig-4.83
#| fig-cap: "Avaliação docente do estímula à participaçõa em eventos científicos."
#| fig-width: 4
#| fig-height: 4
