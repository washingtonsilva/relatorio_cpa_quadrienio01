...
para desenvolver um planejamento robusto de autoavaliação. Este 
...
a produção de resultados concretos para seu aprimoramento.
...
novembro de 2024 [@portaria1706ifmg]. Apesar disso, versões preliminares 
dessa política já orientavam as ações desde os primeiros anos, servindo 
como base para o planejamento das atividades avaliativas.

O planejamento da autoavaliação foi estruturado em etapas que incluíram:
...
tabela_planejamento |>
  ...
  kable_styling(
    latex_options = c("HOLD_position", "hover", "repeat_header"),
...
::: {.callout-note icon=false}
## **VI. Sugestões de Melhorias para as Disciplinas Optativa**s
