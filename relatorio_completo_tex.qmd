...
Resultados da Autoavaliação (@sec-resultados), Ações Executadas e Demandadas 
a partir da Autoavaliação (@sec-acoesdemanda) e Meta-Avaliação 
(@sec-metaavaliacao). 
...
```{r}
#| tbl-cap: "Demandas Identificadas no Processo de Autoavaliaçào e Ações Executadas."

tabela_demandas <- data.frame(
  Demanda = c(
    "Necessidade de disciplina para exposição do desenvolvimento dos projetos de Qualificação e Dissertação.",
    "Redução da carga de disciplinas obrigatórias, considerando o perfil profissional dos mestrandos.",
    "Maior suporte ao trabalho dos docentes e discentes pela coordenação."
  ),
  Acao = c(
    ...
    "Suporte ao trabalho dos docentes e discentes."
  ),
  Dimensao = c(
    "Matriz Curricular",
    "Matriz Curricular",
...
na @tbl-5.2 deste relatório. Entre as principais iniciativas propostas 
