...
Além disso, a Comissão de Autoavaliação considerou informações complementares obtidas ao longo 
...
A Comissão de Autoavaliação buscou garantir que essas ações fossem representativas das necessidades 
...
O Relatório Integral da Comissão de Autovaliação (Comissão de Autoavaliação) 
do Programa de Pós-Graduação em Administração do IFMG - Campus Formiga, 
referente ao quadriênio 2021-2024, evidencia o compromisso institucional com a 
...
infraestrutura disponível, entre outras. Por outro lado, foram apontadas 
oportunidades de melhoria relacionadas à infraestrutura e à ampliação 
de atividades extracurriculares, entre outras.**
...
contínua. A implementação das ações propostas será monitorada pela Comissão de 
Autoavaliação em ciclos avaliativos futuros, assegurando que os resultados 
contribuam efetivamente para o aperfeiçoamento do programa. A reflexão crítica 
